...
```
cd existing_repo
git remote add origin https://gitlab.com/lzkolosova/data4team21.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/lzkolosova/data4team21/-/settings/integrations)
